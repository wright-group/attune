...
with open(os.path.join(os.path.dirname(here), "attune", "VERSION")) as version_file:
...
sys.path.insert(0, os.path.abspath("../attune"))
...
man_pages = [(master_doc, "attune", "attune Documentation", [author], 1)]
